...
The presence of `irkpackage.toml` is important.

For now we just copied the content of `pyirk-core/tests/testdata/ocse_subset` (which was generated by `pyirk --update-test-data`).
